...
import (
	...
	"github.com/apstndb/go-lsp-export/internal/diff/difftest"
	// "github.com/apstndb/go-lsp-export/internal/testenv"
)
...
func TestRegressionOld001(t *testing.T) {
	a := "// Copyright 2019 The Go Authors. All rights reserved.\n// Use of this source code is governed by a BSD-style\n// license that can be found in the LICENSE file.\n\npackage diff_test\n\nimport (\n\t\"fmt\"\n\t\"math/rand\"\n\t\"strings\"\n\t\"testing\"\n\n\t\"github.com/apstndb/go-lsp-export/gopls/internal/lsp/diff\"\n\t\"github.com/apstndb/go-lsp-export/internal/diff/difftest\"\n\t\"github.com/apstndb/go-lsp-export/gopls/internal/span\"\n)\n"
